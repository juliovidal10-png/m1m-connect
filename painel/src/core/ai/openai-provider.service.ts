    ...
    const guardResponse =
      await client.responses.create({
        ...
        instructions: [
          ...
          "Revise a RESPOSTA CANDIDATA usando SOMENTE os fatos e regras presentes no PROMPT DO SISTEMA e na MENSAGEM/CONTEXTO DO CLIENTE fornecidos abaixo.",
          "Nao acrescente servicos, produtos, precos, prazos, formas de pagamento, politicas, enderecos, horarios, condicoes ou qualquer outro fato empresarial que nao esteja sustentado pelo contexto fornecido.",
          "Se a resposta candidata afirmar algo empresarial sem sustentacao, remova a afirmacao. Quando necessario, diga de forma natural que essa informacao nao esta disponivel no contexto, sem inventar substitutos.",
          "Preserve fatos sustentados, inclusive dados estruturados como PIX, beneficiario, horarios e demais informacoes realmente presentes no contexto.",
          ...
          "Use no maximo UMA pergunta na resposta final, e somente quando ela for realmente necessaria para continuar o atendimento.",
